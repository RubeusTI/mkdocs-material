...
| `codNivelEnsino` | `string` | Sim | Código único de identificação do nível de ensino.<br><br>[Listar níveis de ensino](/api_crm/metodosdelistagem/#listar-niveis-de-ensino)<br>**Enviar o campo** `codigo` | 
